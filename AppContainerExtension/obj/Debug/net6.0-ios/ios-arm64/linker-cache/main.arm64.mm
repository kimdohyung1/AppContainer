...
extern void *mono_aot_module_AppContainerExtension_info;
...
{
	mono_aot_register_module (mono_aot_module_AppContainerExtension_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "AppContainerExtension.dll";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
...
int main (int argc, char **argv)
{
	...
	argv [0] = (char *) "AppContainerExtension";
